...
MS_1000 = 1000
REWARD = 100
QUEST_INIT = 28 # SE CUENTA A PARTIR DEL CERO
LIVES_INIT = 0
SCORE_INIT = 0
PLAY_TIME_INIT = 0
YOUWIN_TIME = 5
...
NO_EFFECT_BUTTONS = [ON_MUSIC_BUTTON,ON_EFFECTS_BUTTON,EASY_BUTTON,MIDDLE_BUTTON,HARD_BUTTON,YES_BUTTON,NO_BUTTON]
